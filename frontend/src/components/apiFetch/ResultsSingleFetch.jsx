...
export default function SingleFetchResults({ forwardResponse, buttonResponse, reverseResponse, userInput }) {
	...
	const handleCopyLatitude = () => {
		if (!result || !result.features || !result.features[1]) {
	...
	return (
		<div>
			{/* here for debuggin if responses are not working as indended 
				...
				<div>
					...
					<div style={{ border: "1px solid black", padding: "4px" }}>
						...
						<div>
							...
							<p>geolocation returned for (longitude, latitude) :{" " + result.features[0].geometry.coordinates[0] + ", " + result.features[0].geometry.coordinates[1]}</p>
						</div>
					...
					<p>
						...
						<GcdsButton GcdsButton buttonRole="secondary" buttonId="Copy Longitude" size="small" name="Copy Longitude" style={{ marginLeft: "10px" }} onClick={handleCopyAddress}>
							Copy
						</GcdsButton>
					</p>
					<p>
						Longitude: {result.features[0].geometry.coordinates[0]}
						<GcdsButton GcdsButton buttonRole="secondary" buttonId="Copy Longitude" size="small" name="Copy Longitude" style={{ marginLeft: "10px" }} onClick={handleCopyLongitude}>
							Copy
						</GcdsButton>
					</p>
					...
					<p>
						...
						<GcdsButton GcdsButton buttonRole="secondary" buttonId="Copy Latitude" size="small" name="Copy Latitude" style={{ marginLeft: "10px" }} onClick={handleCopyLatitude}>
							Copy
						</GcdsButton>
					</p>
